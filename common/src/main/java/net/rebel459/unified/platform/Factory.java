...
public final class Factory {
    ...
    public interface Helpers {
        HelpersImpl.CreativeEntries createCreativeEntries();
        HelpersImpl.LootTables createLootTables();
        HelpersImpl.Packs createPacks();
        HelpersImpl.FurnaceFuels createFurnaceFuels();
        HelpersImpl.StrippableBlocks createStrippableBlocks();
        HelpersImpl.NetworkPayloads createNetworkPayloads();
        HelpersImpl.Platform createPlatform();
    }
    ...
    public interface ClientHelpers {
        ClientHelpersImpl.ParticleProviders createParticleProviders();
